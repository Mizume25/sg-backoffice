...
<template>
  <div class="flex flex-col gap-4 h-full p-10">
    ...
    <div class="flex flex-col lg:flex-row gap-4 flex-1 overflow-hidden">
      ...
      <div
        class="w-full lg:w-96 shrink-0 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent scrollbar-thumb-rounded-full">
        ...
        <Record v-else="record" variant="min-h-full" :record="record" />
